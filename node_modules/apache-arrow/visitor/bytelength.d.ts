...
import { DataType, Dictionary, Float, Int, Date_, Interval, Time, Timestamp, Duration, Bool, Null, Utf8, Binary, Decimal, FixedSizeBinary, List, FixedSizeList, Map_, Struct, DenseUnion, SparseUnion } from '../type.js';
/** @ignore */
...
export declare class GetByteLengthVisitor extends Visitor {
    ...
    visitDuration(____: Data<Duration>, _: number): number;
